...
Run from project root: python scripts/generate_dbml.py

Usage:
    python scripts/generate_dbml.py                    # Print DBML to console
python scripts/generate_dbml.py --file output.dbml # Save to file
"""
