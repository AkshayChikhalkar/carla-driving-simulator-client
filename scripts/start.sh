...
# Check if we're running in separate container mode
if [ "$CONTAINER_MODE" = "separate" ]; then
    echo "Running in separate container mode..."
    
    # Create necessary directories if they don't exist
    mkdir -p /app/config /app/logs /app/reports
    ...
    echo "Running in monolithic mode..."
