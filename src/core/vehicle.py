...
class VehicleManager:
    ...
    def update_state(self) -> None:
        ...
        if self._target_point is not None:
            ...
            heading_to_target = math.degrees(math.atan2(
            ...
            heading_difference = (heading_difference + 180) % 360 - 180  # Normalize to [-180, 180]
    ...
    def reset(self) -> None:
        ...
        if self.vehicle is not None:
            ...
            self._state = VehicleState(
                speed=0.0,
                position=(self._spawn_point.location.x,
                         self._spawn_point.location.y,
                         self._spawn_point.location.z),
                rotation=(self._spawn_point.rotation.pitch,
