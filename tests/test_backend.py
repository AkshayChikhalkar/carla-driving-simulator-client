...
def mock_carla():
    ...
    with patch('src.core.simulation_runner.SimulationRunner') as mock_runner:
        ...
        mock_runner_instance.scenario_registry.get_available_scenarios.return_value = ['test_scenario1', 'test_scenario2']
...
def test_simulation_control(client, mock_carla):
    ...
    start_response = client.post("/api/simulation/start", 
